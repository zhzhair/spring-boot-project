package com.github.zhzhair.useraction.common.config.mvc.interceptor;

import com.alibaba.fastjson.JSONObject;
import com.github.zhzhair.useraction.common.annotations.AccessLimit;
import com.github.zhzhair.useraction.common.base.dto.BaseResponse;
import com.github.zhzhair.useraction.common.constant.CountType;
...
public class TooMuchSubmitInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        if(o instanceof ResourceHttpRequestHandler) return true;
    ...
    public void afterCompletion(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o, Exception e) {
        if(o instanceof ResourceHttpRequestHandler) return;
        HandlerMethod method = (HandlerMethod)o;
        Class<?> clazz = method.getMethod().getDeclaringClass();
        AccessLimit accessLimit = method.getMethodAnnotation(AccessLimit.class);
        if((clazz.getDeclaredAnnotation(RestController.class) != null || clazz.getDeclaredAnnotation(Controller.class) != null) && accessLimit != null){
