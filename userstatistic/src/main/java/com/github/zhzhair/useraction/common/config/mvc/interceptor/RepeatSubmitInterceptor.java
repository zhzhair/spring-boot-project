...
public class RepeatSubmitInterceptor implements HandlerInterceptor {
    ...
    private static final RedisScript<Long> LUA_SCRIPT = new DefaultRedisScript("local flag = redis.call('get',KEYS[1]);if flag then return false; else redis.call('setex',KEYS[1],10,''); return true; end", Long.class);
