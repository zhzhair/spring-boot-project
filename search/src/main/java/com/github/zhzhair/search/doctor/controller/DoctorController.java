package com.github.zhzhair.search.doctor.controller;

import com.github.zhzhair.search.common.base.dto.BaseResponse;
import com.github.zhzhair.search.doctor.service.DoctorGroupByService;
import com.github.zhzhair.search.doctor.service.DoctorService;
...
public class DoctorController {
    ...
    @ApiOperation(value = "根据医生id查询医生数据", notes = "根据医生id查询医生数据")
    ...
    @ApiOperation(value = "根据医院id查询医生数据", notes = "根据医院id查询医生数据")
