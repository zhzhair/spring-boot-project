package com.github.zhzhair.main.common.config.aspect;

import com.alibaba.fastjson.JSONObject;
import com.github.zhzhair.main.common.annotations.LogForTask;
...
public class LogAspect {
    ...
    @Pointcut(value = "execution(* com.github.zhzhair.main.*.controller.*.*(..))")
    public void logPointCut() {

    }

    @Pointcut(value = "execution(* com.github.zhzhair.main.*.task.*.*(..))")
     ...
     * 记录controller日志环绕通知
     */
    @Around(value = "logPointCut() && @annotation(org.springframework.web.bind.annotation.RequestMapping) && !@annotation(com.github.zhzhair.main.common.annotations.NotAutoLog)")
