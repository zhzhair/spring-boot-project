package com.github.zhzhair.operation.feedback.service.impl;

import com.github.zhzhair.operation.common.base.exception.BusinessException;
import com.github.zhzhair.operation.common.sql.FeedbackReplySql;
import com.github.zhzhair.operation.common.sql.FeedbackSql;
import com.github.zhzhair.operation.common.util.GeneratorUtil;
...
import com.github.zhzhair.operation.feedback.service.FeedbackService;
...
public class FeedbackServiceImpl implements FeedbackService {
    ...
    public FeedbackEntity uploadFeedback(FeedbackInfo feedbackInfo, int userId) {
        ...
        jdbcTemplate.update((connection)->{
            ...
            ps.setString(3, GeneratorUtil.getMobileStr(userId));
        ...
        feedbackEntity.setMobile(GeneratorUtil.getMobileStr(userId));
