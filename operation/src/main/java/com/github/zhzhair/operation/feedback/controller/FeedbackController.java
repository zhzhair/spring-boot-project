package com.github.zhzhair.operation.feedback.controller;
...
public class FeedbackController {
    ...
    @ApiOperation(value = "用户反馈数据入库", notes = "用户反馈，添加记录从app系统调用接口，app系统查看记录从此系统的接口请求数据")
    ...
    public BaseResponse<FeedbackEntity> uploadFeedback(@RequestBody FeedbackInfo feedBackInfo, @RequestParam int userId) {
        ...
        baseResponse.ok(feedbackEntity);
        return baseResponse;
    }
